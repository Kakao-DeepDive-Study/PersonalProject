...
public enum ErrorCode {
    ...
    NOT_FOUND_EVCHARGE(40404, HttpStatus.NOT_FOUND, "해당 충전소가 존재하지 않습니다."),
    NOT_FOUND_CITY(40405, HttpStatus.NOT_FOUND, "해당 도/시가 존재하지 않습니다."),
    NOT_FOUND_COUNTRY(40406, HttpStatus.NOT_FOUND, "해당 군/구가 존재하지 않습니다."),
